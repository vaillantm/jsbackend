...
function buildPaths() {
    return {
        ...
        '/api/categories': {
            ...
            post: { tags: ['Categories'], summary: 'Create category', security: bearer(), requestBody: { required: true, content: { 'application/json': { schema: { $ref: '#/components/schemas/Category' } } } }, responses: { '201': { description: 'Created' } } }
        },
        '/api/categories/{id}': {
            ...
            patch: { tags: ['Categories'], summary: 'Update category', security: bearer(), parameters: [{ name: 'id', in: 'path', required: true, schema: { type: 'string' } }], requestBody: { content: { 'application/json': { schema: { $ref: '#/components/schemas/Category' } } } }, responses: { '200': { description: 'OK' } } },
